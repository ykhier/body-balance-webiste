      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {SERVICES.map((service, i) => (
            <Reveal key={service.title} effect="fade-up" delay={i * 120}>
              <div
                className={`h-full bg-gradient-to-br ${service.gradient} dark:from-gray-800 dark:to-gray-700 rounded-3xl p-6 border border-white dark:border-gray-600 flex gap-5 items-start shadow-card hover:shadow-soft hover:-translate-y-1.5 transition-all duration-300 group`}
              >
                <div
                  className="flex-shrink-0 w-14 h-14 bg-white dark:bg-gray-600 rounded-2xl flex items-center justify-center text-3xl shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300"
                  aria-hidden="true"
                >
                  {service.icon}
                </div>
        ...
        <Reveal effect="scale-in" delay={100} className="mt-12">
          <div className="bg-gradient-to-l from-rose-500 to-rose-400 rounded-3xl p-8 text-center text-white">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-rose-500 font-bold px-8 py-3 rounded-full hover:bg-rose-50 hover:scale-105 active:scale-95 transition-all shadow"
            >
