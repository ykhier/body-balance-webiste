...
export default function Hero() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute top-10 left-10 w-72 h-72 bg-rose-100 rounded-full blur-3xl opacity-50 pointer-events-none"
      />
      <div
        aria-hidden="true"
        data-parallax="true"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 py-16">
          ...
          <div className="flex-1 text-center md:text-right">
            ...
            <div className="hero-anim-social flex flex-wrap gap-3 mt-4 justify-center md:justify-start">
              <a
                ...
                className="inline-flex items-center gap-2 border-2 border-rose-400 text-rose-500 font-bold px-6 py-3 rounded-full hover:bg-rose-50 transition-all duration-200 text-sm"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border-2 border-pink-300 text-pink-500 font-bold px-6 py-3 rounded-full hover:bg-pink-50 transition-all duration-200 text-sm"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
          ...
          <div className="hero-anim-image flex-shrink-0 flex flex-col items-center gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-card px-6 py-3 text-center border border-rose-50 dark:border-gray-700">
